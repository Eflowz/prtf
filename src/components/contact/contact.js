        ...
        />
          ...
          <div className='w-full'> 
              ...
              <form className="w-full flex flex-col gap-4 lgl:gap-6 py-2 lgl:py-5">
                ...
                {
                    successMsg && (<p className="py-3 bg-gradient-to-r from-[#23272b] to-[#23272b] shadow-shadowOne text-center text-green-500 text-base tracking-wide animate-bounce">{successMsg}</p>
                )}
